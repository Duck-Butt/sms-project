...
response = router.procss_user_input(user_input)


while True:
    user = input("사용자: ")
    res = process_user_input(user)
    print("AI:", res)
...
if __name__ == '__main__':
    ...
    school_info = load_data(INFO_FILE, "학교_일반_정보")
    meal_info = load_data(MEAL_API_FILE, "급식_데이터")
    ...
    while True:
        ...
        # 3. 답변 생성
        response_text = get_chatbot_response(user_input, chatbot_data)
